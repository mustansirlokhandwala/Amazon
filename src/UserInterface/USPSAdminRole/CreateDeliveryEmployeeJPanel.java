...
public class CreateDeliveryEmployeeJPanel extends javax.swing.JPanel {

        private JPanel userProcessContainer;
       private EcoSystem ecoSystem;
       private USPS usps;
    public CreateDeliveryEmployeeJPanel(JPanel userProcessContainer , EcoSystem ecoSystem , USPS usps) {
        initComponents();
    ...
    private void createwareHouseAdminJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createwareHouseAdminJButtonActionPerformed
        ...
        if(firstName.trim().isEmpty() || lastName.trim().isEmpty() || Age.trim().isEmpty()|| street.trim().isEmpty() || city.trim().isEmpty() || state.trim().isEmpty() || country.trim().isEmpty() || zipcode.trim().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please Complete all the fields in the form");
        }
        ...
        Employee employee = usps.getEmployeeDirectory().createandAddEmployee();
        employee.setPerson(person);
        }catch(NumberFormatException e){JOptionPane.showMessageDialog(null,"Plese Enter Numerical Data only  in the age and zipcode filed");return;}
