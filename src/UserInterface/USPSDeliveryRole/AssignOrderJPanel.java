...
public class AssignOrderJPanel extends javax.swing.JPanel {
    ...
    public AssignOrderJPanel(JPanel upc , UserAccount account , USPS usps , DeliveryVans deliveryVans) {
        initComponents();
    ...
    private void assignToMeJbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignToMeJbuttonActionPerformed
       ...
       OrderRequest or = (OrderRequest)deliveryPickUpTable.getValueAt(selectedRow, 0);
       ...
       populateDeliveryTable();
       deliveryVans.getPickupQueue().addWorkRequest(or);
