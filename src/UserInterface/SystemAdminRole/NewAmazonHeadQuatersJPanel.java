...
public class NewAmazonHeadQuatersJPanel extends javax.swing.JPanel {

    private EcoSystem ecoSystem;
    private JPanel userProcessContainer;
    public NewAmazonHeadQuatersJPanel(EcoSystem ecoSystem , JPanel upc) {
        initComponents();
    ...
    private void createnewHeadquaterJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createnewHeadquaterJButtonActionPerformed
        ...
        for(Enterprise enterprise : countryNetwork.getEnterpriseDirectory().getEnterpriseList()){
            if(enterprise.getEnterpriseType().equals(Enterprise.EnterpriseType.Amazon)){
                ...
                JOptionPane.showMessageDialog(null,"A headquaters in this Country already exist");
                return;
        ...
        Enterprise e =countryNetwork.getEnterpriseDirectory().createandAddEnterprise(name, EnterpriseType.Amazon, add);
