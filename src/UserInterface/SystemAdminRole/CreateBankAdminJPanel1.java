 ...
 * @author Mustansir
 */
public class CreateBankAdminJPanel1 extends javax.swing.JPanel {

    private Bank bank ;
    private JPanel userProcessContainer;
    private EcoSystem ecoSystem;
    public CreateBankAdminJPanel1(Bank bank , JPanel userProcessContainer , EcoSystem ecoSystem) {
        initComponents();
        this.ecoSystem = ecoSystem;
        this.bank = bank;
        this.userProcessContainer= userProcessContainer;
        CountryTxtField.setText(bank.getAddress().getCountry());
        populatestateCombo();
    }
     ...
     public void populatestateCombo(){
        ...
        for(Network network : ecoSystem.getNetworkDirectory().getNetworkList()){
            if(network.getName().equals(bank.getAddress().getCountry())){
    ...
    private void createJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createJButtonActionPerformed
        ...
        UserAccount ua = bank.getUserAccountDirectory().createandAddUserAccount();
